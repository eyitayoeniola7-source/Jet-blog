...
const Footer = () => {
  return (
    <footer className="bg-violet-50 rounded-lg py-12 mt-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {/* Email */}
              <a href="#email" className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center hover:bg-purple-300 transition">
              ...
              {/* Behance */}
              <a href="#behance" className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center hover:bg-purple-300 transition">
                <span className="text-gray-700 font-bold">Be</span>
              </a>
              {/* Dribbble */}
              <a href="#dribbble" className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center hover:bg-purple-300 transition">
                <svg className="w-5 h-5 text-gray-700" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0 2 2 0 011.523-1.943A5.977 5.977 0 0116 10c0 .34-.028.675-.083 1H15a2 2 0 00-2 2v2.197A5.973 5.973 0 0110 16v-2a2 2 0 00-2-2 2 2 0 01-2-2 2 2 0 00-1.668-1.973z" clipRule="evenodd" />
                </svg>
              </a>
              {/* LinkedIn */}
              <a href="#linkedin" className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center hover:bg-purple-300 transition">
