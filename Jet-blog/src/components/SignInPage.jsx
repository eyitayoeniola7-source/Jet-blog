    ...
    <div className="min-h-screen bg-purple-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-xl w-full">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
          ...
          <button className="w-full py-4 px-6 border-2 border-gray-300 rounded-2xl flex items-center justify-center gap-3 hover:bg-gray-50 transition font-medium text-gray-700 mt-4">
